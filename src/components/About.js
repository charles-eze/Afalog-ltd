    ...
    return (
        <div className='relative bg-gray-100 fontt'>
            <div className='bg-gray-100 h-40 w-full -bottom-40 flex absolute '></div>
                <div className='relative bg-gray-50 flex justify-evenly top-24 md:top-28  mr-3.5 ml-3.5 pb-2 md:mr-36 md:ml-36 mb-4 md:mb-9 md:pb-12  border border-gray-300'
