...
const Contact = () => {
    return (
        <div className='relative bg-gray-100'
            ...
            <div className='relative  block md:flex md:justify-evenly top-24 md:top-28 mr-3.5 ml-3.5 pb-2 md:mr-24 md:ml-24 mb-4 md:mb-11 md:pb-7 bg-gray-50 border border-gray-200'
                ...
                <div className='pl-4 pr-4 md:pl-32 md:pr-16'>
                    ...
                    <p className='text-sm md:text-lg'>Off Ola Ayinde Street</p>
                    <p className='text-sm md:text-lg'>Ikeja</p>
                    <p className='text-sm md:text-lg'>Lagos,</p>
                    <p className='text-sm md:text-lg'>Nigeria</p>
                    <p className='pt-1 text-sm md:text-lg font-bold'>Tel: +234 (0) 7035441395</p>
                ...
                <div className='pl-4 pr-4 md:pl-32 md:pr-16 pb-3.5 md:pb-0'>
                    <span className='flex pt-7 pb-7 items-center'>
                        <FcContacts
                            className='text-blue-600 text-2xl mr-1.5 md:mr-5 '/>
                    ...
                    <p className='text-sm md:text-lg'>Off Cresent street, Rumuigbo</p>
                    <p className='text-sm md:text-lg'>Port Harcourt</p>
                    <p className='text-sm md:text-lg'>Rivers,</p>
                    <p className='text-sm md:text-lg'>Nigeria</p>
                    <p className='pt-1 text-sm md:text-lg font-bold'>Tel: +234 (0) 7068666696</p>
                    <p className='pt-0.5 text-sm md:text-lg font-semibold'>Email: info@afalog.com</p>
                    <p className='pt-0.5 text-sm md:text-lg font-semibold'>Email2: afalogmedicaldiagnostics@gmail.com</p>
                </div>
                </Fade>
