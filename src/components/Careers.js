...
const Careers = () => {
    return (
        <div className='relative  fontt bg-gray-50'>
            ...
            <div className='relative block md:flex md:justify-evenly top-24 md:top-28 mr-3.5 ml-3.5 pb-2 md:mr-36 md:ml-36 mb-4 md:mb-11 md:pb-12 border border-gray-200 bg-white'
                style={{boxShadow: "0 0.55rem 1rem rgba(0, 0, 0, 0.45)"}}>
                <Fade left> 
                <img 
                    src={image}
                    className=' pl-4 md:pl-20 h-36 md:h-56'
                    alt='career' />
                </Fade>
                <Fade right>
                <div className='pl-3.5 pr-2.5 md:pl-32 md:pr-16'>
                    <span className='flex pt-7 pb-7 items-center'>
                        <FaUserTie 
                            className='text-blue-600 text-xl md:text-3xl mr-5 '/>
